...
export default function SmjerPregledTablica({ smjerovi, navigate, brisanje }) {
    ...
    const getSortIcon = (columnKey) => {
        ...
        const sortedSmjerovi = () => {
        if (!smjerovi || sortConfig.direction === null) {
            return smjerovi;
        }

        const sorted = [...smjerovi].sort((a, b) => {
    ...
    return (
        <Table striped bordered hover responsive>
            ...
            <tbody>
                {sortedSmjerovi() && sortedSmjerovi().map((smjer) => (
                    <tr key={smjer.sifra}>
                        ...
                        <td>
                            <Button onClick={() => navigate(`/smjerovi/${smjer.sifra}`)} title="Promjeni">
                                 <FaEdit />
                            </Button>
                            &nbsp;&nbsp;
                            <Button variant="danger" onClick={() => brisanje(smjer.sifra)} title="Obriši">
                                 <FaTrash />
                            </Button>
                        </td>
                    </tr>
