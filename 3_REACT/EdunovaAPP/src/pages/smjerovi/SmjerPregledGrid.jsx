...
export default function SmjerPregledGrid({ smjerovi, navigate, brisanje }) {
    return (
        <Container className="py-3 px-0">
            <Row>
                {smjerovi && smjerovi.map((smjer) => (
                    <Col key={smjer.sifra} xs={12} md={6} className="mb-4">
                        <Card className="shadow-sm h-100">
                            ...
                            <Card.Body>
                                <div className="d-flex justify-content-between mb-2">
                                    ...
                                    <span className="fw-semibold">{smjer.trajanje} h</span>
                                </div>
